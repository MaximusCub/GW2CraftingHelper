...
- Build command run and result (`dotnet build TaimisToolbench.sln -p:Platform=x64`)
- Test command run and result (`dotnet test TaimisToolbench.sln` - all three test projects, matching CI)
