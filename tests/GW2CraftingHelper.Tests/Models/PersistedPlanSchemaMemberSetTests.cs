...
namespace GW2CraftingHelper.Tests.Models
{
    ...
    // several more all grew public properties after the 2 -> 3 bump without
    ...
    public class PersistedPlanSchemaMemberSetTests
    {
        ...
        public void PersistedPlanGraph_PublicMemberSignature_MatchesSnapshot()
        {
            string[] expected =
            {
                ...
                "CompetencyOpportunity.Disciplines:IReadOnlyList`1",
                "CompetencyOpportunity.ItemId:Int32",
                "CompetencyOpportunity.MinRating:Int32",
                "CostLine.Count:Int32",
                "CostLine.Id:Int32",
                "CostLine.Type:String",
                "CraftingPlan.CurrencyCosts:List`1",
                "CraftingPlan.Steps:List`1",
                "CraftingPlan.TargetItemId:Int32",
                "CraftingPlan.TargetQuantity:Int32",
                "CraftingPlan.TimegatedItems:List`1",
                "CraftingPlan.TotalCoinCost:Int64",
                "CraftingPlanResult.AcquisitionHints:IReadOnlyDictionary`2",
                "CraftingPlanResult.CharacterDisciplines:IReadOnlyList`1",
                "CraftingPlanResult.CompetencyOpportunities:List`1",
                "CraftingPlanResult.CraftingProfit:Nullable`1",
                "CraftingPlanResult.CraftingTree:CraftingTreeNode",
                "CraftingPlanResult.CurrencyMetadata:IReadOnlyDictionary`2",
                "CraftingPlanResult.DailyCooldownItems:IReadOnlyDictionary`2",
                "CraftingPlanResult.DebugLog:List`1",
                "CraftingPlanResult.ExcessCraftOutputs:List`1",
                "CraftingPlanResult.ItemMetadata:IReadOnlyDictionary`2",
                "CraftingPlanResult.MaterialOpportunityCost:Nullable`1",
                "CraftingPlanResult.MultiItemRoots:List`1",
                "CraftingPlanResult.NetSaleValue:Nullable`1",
                "CraftingPlanResult.OwnedCurrencyAmounts:IReadOnlyDictionary`2",
                "CraftingPlanResult.Plan:CraftingPlan",
                "CraftingPlanResult.PriceBasis:PriceBasis",
                "CraftingPlanResult.ProbabilisticForgeOutputItemIds:List`1",
                "CraftingPlanResult.RecipeSheetSavingsOpportunities:List`1",
                "CraftingPlanResult.RequestedItems:IReadOnlyList`1",
                "CraftingPlanResult.RequiredDisciplines:List`1",
                "CraftingPlanResult.RequiredRecipes:List`1",
                "CraftingPlanResult.SeasonalVendorTips:List`1",
                "CraftingPlanResult.SellableQuantity:Int32",
                "CraftingPlanResult.SolveContext:PlanSolveContext",
                "CraftingPlanResult.TargetUnitSellPrice:Nullable`1",
                "CraftingPlanResult.UsedMaterials:List`1",
                ...
                "CraftingTreeNode.CheapestCraftDisciplines:IReadOnlyList`1",
                "CraftingTreeNode.CheapestCraftMinRating:Int32",
                "CraftingTreeNode.CheapestCraftRealCost:Nullable`1",
                "CraftingTreeNode.CheapestCraftUntrained:Boolean",
                "CraftingTreeNode.Children:IReadOnlyList`1",
                ...
                "CraftingTreeNode.CraftExcludedDisciplines:IReadOnlyList`1",
                "CraftingTreeNode.CraftExcludedMinRating:Int32",
                "CraftingTreeNode.CraftExcludedRealCost:Nullable`1",
                "CraftingTreeNode.CraftsNeeded:Nullable`1",
                "CraftingTreeNode.Decision:CraftingDecision",
                "CraftingTreeNode.DecisionValue:Nullable`1",
                ...
                "CraftingTreeNode.RecipeExpectedOutputCount:Nullable`1",
                "CraftingTreeNode.RecipeId:Nullable`1",
                "CraftingTreeNode.RecipeOutputCount:Nullable`1",
                "CraftingTreeNode.ReferenceRecipeDisciplines:List`1",
                "CraftingTreeNode.ReferenceRecipeId:Nullable`1",
                "CraftingTreeNode.ReferenceRecipeIsLearnedFromItem:Boolean",
                "CraftingTreeNode.ReferenceRecipeMinRating:Int32",
                "CraftingTreeNode.SubtreeCost:Nullable`1",
                "CraftingTreeNode.UnitCost:Nullable`1",
                "CraftingTreeNode.VendorComponentCostsUnreliable:Boolean",
                "CraftingTreeNode.VendorCurrencyCosts:IReadOnlyList`1",
                ...
                "CurrencyValuation.ClearedCurrencyIds:IReadOnlyCollection`1",
                "CurrencyValuation.CopperPerUnit:IReadOnlyDictionary`2",
                ...
                "ExcessCraftOutput.ReclaimValue:Nullable`1",
                "HomesteadEfficiencyTiers.TierByMaterialId:IReadOnlyDictionary`2",
                ...
                "PersistedPlan.IgnoredItemIds:IReadOnlyList`1",
                "PersistedPlan.NodeOverrides:IReadOnlyDictionary`2",
                "PersistedPlan.PriceBasis:PriceBasis",
                "PersistedPlan.RequestItems:IReadOnlyList`1",
                ...
                "PillSourceCostBreakdown.CostLines:List`1",
                "PillSourceCostBreakdown.DecisionValue:Nullable`1",
                ...
                "PlanSolveContext.AccountItems:IReadOnlyList`1",
                "PlanSolveContext.AcquisitionHints:IReadOnlyDictionary`2",
                "PlanSolveContext.ActiveCharacterName:String",
                "PlanSolveContext.CharacterDisciplines:IReadOnlyList`1",
                "PlanSolveContext.CompetencyIndependentForceBuyNodeIds:ISet`1",
                "PlanSolveContext.CurrencyMetadata:IReadOnlyDictionary`2",
                "PlanSolveContext.CurrencyValuation:CurrencyValuation",
                "PlanSolveContext.DailyCooldownItems:IReadOnlyDictionary`2",
                "PlanSolveContext.ForceBuyOnlyNodeIds:ISet`1",
                "PlanSolveContext.HomesteadTiers:HomesteadEfficiencyTiers",
                "PlanSolveContext.LearnedRecipeIds:ISet`1",
                "PlanSolveContext.Metadata:IReadOnlyDictionary`2",
                "PlanSolveContext.OwnMaterialsMode:OwnMaterialsMode",
                "PlanSolveContext.OwnedCurrencyAmounts:IReadOnlyDictionary`2",
                "PlanSolveContext.OwnedQuantityUsedByNodeId:IReadOnlyDictionary`2",
                "PlanSolveContext.OwnedVendorItemAmounts:IReadOnlyDictionary`2",
                "PlanSolveContext.PriceBasis:PriceBasis",
                "PlanSolveContext.Prices:IReadOnlyDictionary`2",
                "PlanSolveContext.Quantity:Int32",
                "PlanSolveContext.RequestedItems:IReadOnlyList`1",
                "PlanSolveContext.TargetItemId:Int32",
                "PlanSolveContext.Tree:RecipeNode",
                "PlanSolveContext.UnreducedTree:RecipeNode",
                "PlanSolveContext.UsedMaterials:List`1",
                "PlanSolveContext.VendorOffers:IReadOnlyDictionary`2",
                ...
                "PlanStep.VendorCurrencyCosts:List`1",
                "PlanStep.VendorOfferCurrencyCostLinesPerBatch:List`1",
                "PlanStep.VendorOfferOutputCount:Int32",
                "RecipeNode.AchievementBit:Nullable`1",
                "RecipeNode.AchievementId:Nullable`1",
                "RecipeNode.Id:Int32",
                ...
                "RecipeNode.Recipes:List`1",
                "RecipeOption.CraftsNeeded:Int32",
                "RecipeOption.Disciplines:List`1",
                "RecipeOption.ExpectedOutputCount:Double",
                "RecipeOption.Flags:List`1",
                "RecipeOption.Ingredients:List`1",
                ...
                "SeasonalVendorTip.WeeklyCap:Nullable`1",
                ...
                "UsedMaterial.Sources:List`1",
                "VendorOffer.CostLines:List`1",
                "VendorOffer.DailyCap:Nullable`1",
                "VendorOffer.HomesteadTier:Nullable`1",
                "VendorOffer.Locations:List`1",
                "VendorOffer.MerchantName:String",
                "VendorOffer.OfferId:String",
                "VendorOffer.OutputCount:Int32",
                "VendorOffer.OutputItemId:Int32",
                "VendorOffer.SeasonalCap:Nullable`1",
                "VendorOffer.SeasonalFestival:String",
                "VendorOffer.WeeklyCap:Nullable`1",
            };
