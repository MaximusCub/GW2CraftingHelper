...
namespace GW2CraftingHelper.Tests.Services
{
    ...
    /// (SHA256.Create()+byte-to-hex loop here, SHA256.HashData+
    /// Convert.ToHexString there), which is why they must still agree on
    ...
    /// VendorOfferUpdater.Tests/VendorOfferHasherGoldenVectorTests.cs
