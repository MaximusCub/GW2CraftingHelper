> **Frozen record - 2026-08-16, branch `decision-invariant-value-own-materials`.** Moved verbatim out of `docs/KNOWN-ISSUES.md`; the heading below is the section's own.
