> **Frozen record - 2026-08-15, branch `w4b-vendor-cost-component-leaves`.** Moved verbatim out of `docs/KNOWN-ISSUES.md`; the heading below is the section's own.
> Point-in-time evidence - it describes the code as it stood that day and may not describe current code. Current documentation is [`docs/`](../../../docs/README.md).

## W4B: Vendor cost-component leaves (2026-08-15)

Designed after live field observation: an "Amalgamated Rift Essence"
