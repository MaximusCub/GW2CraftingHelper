> **Frozen record - 2026-08-08, branch `w3b-generation-progress-rich-logging`.** Moved verbatim out of `docs/KNOWN-ISSUES.md`; the heading below is the section's own.
