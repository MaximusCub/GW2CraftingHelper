> **Frozen record - 2026-08-23, branch `min-width-1436`.** Moved verbatim out of `docs/KNOWN-ISSUES.md`; the heading below is the section's own.
> Point-in-time evidence - it describes the code as it stood that day and may not describe current code. Current documentation is [`docs/`](../../../docs/README.md).

## Minimum width raise (min-width-1436)

Taken from the measured research now committed at
...
tests, so a later change taking the +2pt option (1472) or trimming the
...
- **The +2pt font variant (1472) is a pending decision.** The
...
Gate: PASS after two gate-found fixes (2026-08-23 sandbox sessions,
