...
| `dev-notes/SESSION-STATE.md`, `dev-notes/FEEDBACK-BACKLOG.md`, `dev-notes/SESSION-HANDOFF.md` | Live working state and the field-test ledger. Local-only since 2026-08-31 - private working state, not published. |
