...
namespace GW2CraftingHelper.Services
{
    ...
    public static class TreeRowTooltipComposer
    {
        ...
        // unit-testable (repo invariant, same precedent as
        // ValueDetailTooltipBuilder.FormatCoin). Both formats are trivial
        // and must stay in lockstep only in spirit (same three-unit
        // format), not by shared code.
